# Patch Helen's attached TEACHER docx -> Teacher v9: mirror her latest student edits
# (header now Lesson 2; new Set 3 & Set 4 sentences).
import docx
...
OUT = "/opt/f5-grammar-lesson2/Grammar_Lesson_2_Inversions_Teacher_v9.docx"
...
NEW_SETS = {
    ...
    'Example Set 4 (Never / Rarely / Seldom)': {
        ...
        'answer': "Never do teenagers turn off their notifications before going to sleep, which leads to hours of late-night scrolling."},
